...
void reset(status arg){
  ...
  ::reset();
  property = ({ "outdoors" });
  short_desc = dukeboulevard_3_short; // Needs a description
  long_desc  = dukeboulevard_3_long; // Needs a description
 dest_dir = ({
    roomdir + "northbirchstreet_2", "east",
    roomdir + "innercastlegate", "west",
  });
  items = ({
    "ground", dukeboulevard_3_ground, // Needs a description
    "floor", "=ground",
    "buildings", dukeboulevard_3_buildings, // Needs a description
    "building", "=buildings",
    "houses", "=buildings",
    "house", "=buildings",
    "shops", "=buildings",
